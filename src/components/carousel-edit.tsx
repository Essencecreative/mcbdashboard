        ...
        <div className="max-w-3xl p-6 md:p-8 lg:p-10">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mt-1">
              Update the carousel slide with background image, title, description, and call-to-action.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-3">
              <Label htmlFor="image-upload" className="text-base font-medium">
                Background Image <span className="text-muted-foreground text-sm">(optional - leave unchanged if not updating)</span>
              </Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="title" className="text-base font-medium">
                Title <span className="text-muted-foreground text-sm">(max {MAX_TITLE_WORDS} words)</span>
              </Label>
              <Input
                id="title"
                name="title"
            ...
            <div className="space-y-2">
              <Label htmlFor="description" className="text-base font-medium">
                Description <span className="text-muted-foreground text-sm">(max {MAX_DESC_WORDS} words)</span>
              </Label>
              <Textarea
                id="description"
                name="description"
            ...
            <div className="pt-4 flex gap-3">
              <Button type="submit" size="lg" className="w-full md:w-auto px-8" disabled={submitting}>
                {submitting ? "Updating..." : "Update Carousel Slide"}
              </Button>
              <Button
                type="button"
                variant="outline"

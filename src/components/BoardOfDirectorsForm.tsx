    ...
    <DashboardLayout>
      <div className="w-full bg-white min-h-screen">
        <div className="max-w-3xl p-6 md:p-8 lg:p-10">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Add New Board Member</h1>
            <p className="text-muted-foreground mt-1">
              Create a new board member with photo, position, title, and contact information.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-4 flex gap-3">
              <Button type="submit" size="lg" className="w-full md:w-auto px-8" disabled={submitting}>
                {submitting ? "Creating..." : "Add Board Member"}
              </Button>
              <Button
                type="button"
                variant="outline"

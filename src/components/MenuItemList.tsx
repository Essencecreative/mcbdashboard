  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        ...
        const data = await getMenuItems(category, undefined, undefined)
        ...
        <div className="p-6 md:p-8 lg:p-10">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Manage individual menu items and their page content.
              </p>
            </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-4 text-lg text-gray-600">No menu items yet.</p>

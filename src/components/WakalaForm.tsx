    ...
    <DashboardLayout>
      <div className="w-full bg-white min-h-screen">
        <div className="max-w-3xl p-6 md:p-8 lg:p-10">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Add New Wakala Location</h1>
            <p className="text-muted-foreground mt-1">
              Create a new Mwalimu Wakala location with name, region, district, address, and phone.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              ...
              <Button type="submit" disabled={submitting}>
                {submitting ? "Creating..." : "Create Wakala Location"}
              </Button>
            </div>
          </form>
        </div>

...
export default function CarouselList() {
  ...
  useEffect(() => {
    const fetchCarousels = async () => {
      try {
        setLoading(true)
        setError(null)
        const response = await getCarousels(1, 100) // Fetch all (adjust limit as needed)
  ...
  const handleDelete = async (id: string) => {
    ...
    toast({
      title: "Deleted",
      description: "Carousel slide removed successfully.",
    })
    } catch (err: any) {
      ...
      <div className="w-full bg-white min-h-screen">
        <div className="p-6 md:p-8 lg:p-10">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Carousel Items</h1>
              <p className="text-muted-foreground mt-1">
                Manage all slides in your homepage carousel.
              </p>
            </div>
          ...
          {loading ? (
            <div className="text-center py-12">
              ...
              <p className="text-sm text-muted-foreground mt-4">Loading carousel items...</p>
            </div>
          ) : error ? (
            <div className="text-center py-12">
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-4 text-lg text-gray-600">No carousel items yet.</p>
              <p className="text-sm text-muted-foreground">
                Click "Add New Carousel" to create your first slide.
              </p>
            </div>
          ) : (
